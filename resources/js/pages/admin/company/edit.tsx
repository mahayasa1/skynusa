// resources/js/pages/admin/company/edit.tsx
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Edit Perusahaan</h1>
                            <p className="text-gray-600 mt-1">Perbarui data perusahaan {company.name}</p>
                        </div>
                    </div>
                </div>
                            ...
                            <Card className="shadow-md bg-white text-black">
                                <CardContent className="p-4 space-y-2">
                                    ...
                                    >
                                        ...
                                        {processing ? 'Menyimpan...' : 'Update Perusahaan'}
                                    </Button>
                                    <Link href="/admin/companies">
                                        <Button
                                            type="button"
